      ...
      e = {
        7992: function (t, e, n) {
          var r = {
            ...
            "./SignUp": [9504, 2074, 1888],
            "./SignUp.js": [9504, 2074, 1888],
            "./Social": [2867, 6458],
            "./Social.js": [2867, 6458],
        ...
        9266: function (t, e, n) {
          var r = {
            "./Essential": [3649, 2074, 1888],
            "./Essential.js": [3649, 2074, 1888],
            "./Misc": [5734, 4826, 6592],
            ...
            switch (
              ...
              case "SAVED/REMOVE":
                (0, a.Z)({
                  ...
                  url: "/user/saved/"
                    .concat(e.type, "index.html")
                    .concat(t.match(/ADD/) ? "add" : "remove", "index.html")
                    .concat(e.id),
                });
                break;
              ...
              case "LIST_ITEMS/UPDATE_ITEM":
                (0, a.Z)({
                  ...
                  data: n,
                  method: "POST",
                  url: "".concat(i(e), "update-item/index.html").concat(e.itemId),
                  context: c,
                });
                break;
              case "LIST_ITEMS/DELETE_ITEM":
                (0, a.Z)({
                  ...
                  data: n,
                  method: "POST",
                  url: "".concat(i(e), "delete-item/index.html").concat(e.itemId),
                  context: c,
                });
                break;
              case "LIST_ITEMS/MOVE_ITEMS":
                (0, a.Z)({
                  ...
                  data: n,
                  method: "POST",
                  url: "".concat(i(e), "move-item/index.html").concat(e.itemId),
                  context: c,
                });
                break;
              case "LISTS/UPDATE":
              ...
              case "FOLLOWS/REMOVE":
                (0, a.Z)({
                  ...
                  method: "POST",
                  url: "/ajax/"
                    .concat(t.match(/ADD/) ? "follow" : "unfollow", "index.html")
                    .concat(e.name, "index.html")
                    .concat(e.id),
                });
                break;
              case "AUTOCOMPLETE":
              ...
              case "GET_REVIEWS_PAGE": {
                ...
                (0, a.Z)({
                  ...
                  method: "GET",
                  url: ""
                    .concat(n, "maestro/course-reviews/index.html")
                    .concat(e.courseId, "-")
                    .concat(e.start),
                  parameters: e,
                });
              ...
              case "STUDY_GROUP/COORDINATOR_DEL":
                (0, a.Z)({
                  ...
                  method: "PUT",
                  url: "/api/study-groups/"
                    .concat(e.studyGroupSlug, "coordinator/index.html")
                    .concat(e.id, "/delete"),
                });
                break;
              ...
              case "STUDY_GROUP/ITEM_RETRIEVE":
                (0, a.Z)({
                  ...
                  method: "GET",
                  url: "/api/study-groups/"
                    .concat(e.studyGroupSlug, "index.html")
                    .concat(e.type, "s/index.html")
                    .concat(e.itemId),
                  context: c,
                });
                break;
                ...
                (0, a.Z)({
                  ...
                  url: "/user/study-group/"
                    .concat(
                      ...
                      "enrollee-list/update-item-progress/index.html"
                    )
                    .concat(e.itemId),
                  context: c,
                });
              ...
              case "CLASSROOM/UPDATE_ITEM":
                (0, a.Z)({
                  ...
                  url: "/user/classroom-list/"
                    .concat(e.courseId, "update-item/index.html")
                    .concat(e.itemId),
                  data: n,
                  fetchOptions: s,
                });
          ...
          t.exports = (function () {
            ...
            function J() {
              ...
              var ht = U,
                ...
                Yt = "../www.w3.org/1998/Math/MathML.179.delayed",
                $t = "http://www.w3.org/2000/svg",
                Jt = "../www.w3.org/1999/xhtml.17a.delayed",
                Kt = Jt,
                Xt = !1,
                Qt = void 0,
      ...
      (r.u = function (t) {
        return (
          ...
          "." +
          {
            ...
            1888: "1f03c0fa42fb94d83a15",
            1896: "3c7d3b51f6dbc43445d2",
            1918: "cef3218ebaf0526738de",
            2074: "c4642c0407922b16e0d1",
