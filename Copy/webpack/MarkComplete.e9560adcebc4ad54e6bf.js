    ...
    1029: function (t, e) {
      ...
      e.Z = (t) => {
        ...
        return '\n  <div class="cmpt-modal active">\n    <div data-name="MODAL_CLOSE" data-detail=\'{ "id": "'
          ...
          .concat(
            isNaN(n.height) ? n.height : "".concat(n.height, "px"),
            ';">\n          '
          )
          .concat(
            e,
    ...
    3499: function (t, e, n) {
      ...
      var r = (t) =>
        '\n  <div\n    class="cmpt-select-date relative margin-left-small"\n    data-detail=\''
          .concat(
            JSON.stringify({ ...t }),
            '\'\n  >\n    <label class="text-4 upper color-gray absolute left top">'
          )
          .concat(t.label, "</label>    \n      ")
          .concat(
            o(t) ? (0, i.p6)("".concat(t.year, "/").concat(s(t.month))) : "",
          ...
          .concat(
            o(t) ? "margin-left-xxsmall" : "",
            " radius text-3 padding-horz-xsmall line-wide "
          )
          .concat(
            t.isActive ? "bg-blue-mid" : "bg-gray-light",
            '"\n    >\n    '
          )
          .concat(
            o(t)
              ? t.isActive
                ? '<i class="icon-xsmall icon-pencil-white icon-center"></i>'
                : '<span class="icon-center icon-pencil-charcoal icon-xsmall">Edit</span>'
              : '<span class="text-3 icon-left-small icon-'.concat(
                  t.isActive
                    ? "circle-plus-white color-white"
                    : "circle-plus-charcoal",
                  '">Add</span>'
                ),
            "\n    </button>\n    "
          )
                    ...
                    ((t) =>
                      ' \n<div class="cmpt-select-date-month"> \n  <fieldset class="width-100 relative margin-bottom-xsmall">\n    <label class="text-4 upper color-gray absolute margin-top-xsmall margin-left-small left top">Month</label>\n    <input\n      tabindex="1"\n      data-name="SELECT_DATE_INPUT_MONTH"\n      data-detail=\''
                        ...
                        .concat(
                          [...Array(12).keys()]
                            .map((e) =>
                              '\n        <li class="width-1-3 border-box" style="padding: 2px !important;">\n          <button\n            type="button"\n            tabindex=\'2\'\n            class="btn-white btn-xsmall width-100 '
                                .concat(
                                  parseInt(t.month, 10) === e + 1
                                    ? "selected"
                                    : "",
                                  '"\n            data-name="SELECT_MONTH"\n            data-detail=\''
                                )
                                .concat(
                                  JSON.stringify({ ...t, month: e + 1 }),
                                  "'\n          >\n            "
                                )
                                .concat(
                                  a[e + 1].substring(0, 3),
                          ...
                          [...Array(90).keys()]
                            .map((e) =>
                              '\n          <li class="width-1-3 padding-xxsmall border-box" style="padding: 2px !important;">\n            <button\n              tabindex=\'2\'\n              type="button"\n              class="btn-white btn-xsmall width-100 '
                                .concat(
                                  parseInt(t.year, 10) === l - e
                                    ? "selected"
                                    : "",
                                  '""\n              data-name="SELECT_YEAR"\n              data-detail=\''
                                )
                                .concat(
                                  JSON.stringify({ ...t, year: l - e }),
                                  "'                \n            >\n              "
                                )
                                .concat(
                                  l - e,
          ...
          .concat(
            o(t) ? "".concat(t.year, "/").concat(s(t.month)) : "",
            '"\n      name="'
          )
          .concat(t.name, '"\n      data-detail=\'{"id": "')
          .concat(
      ...
      var c = (t) => {
        ...
        m = (t) => {
          ...
          return '\n  <section class="padding-medium">\n    <header class="padding-bottom-small padding-right-medium border-bottom relative">\n      <h2 class="head-3 margin-bottom-xxsmall">\n      '
            .concat(
              t.completed
                ? '<span class="icon-left-medium icon-progress-done head-3">' +
                    s.s.csr.mark_complete.completed() +
                    "</span>"
                : s.s.csr.mark_complete.mark_as_complete(),
              "\n      "
            )
            .concat(
              "success" === t.status
                ? '<span class="inline-block margin-left-xsmall weight-bold bg-green-xlight color-green text-3">' +
                    s.s.csr.mark_complete.saved() +
                    "</span>"
                : "",
              "\n      </h2>\n    </header>\n    "
            )
                ...
                : ((t) => {
                    ...
                    return '\n  <form\n    class="margin-vert-small"\n    data-name="PROGRESS_COMPLETE"\n    data-detail=\'{\n      "id": "'
                      ...
                      .concat(
                        ...
                        '\n          </li>\n          <li data-template="date-select-completedEndDate-'
                      )
                      .concat(
                        t.id,
                        '" style="min-width: 170px;">\n            '
                      ...
                      .concat(
                        ...
                        '\n          </li>\n        </ul>\n      </fieldset>\n    </div>\n    <button\n      data-track-ga=\'{"category": "mark complete modal", "action": "mark complete", "label": "'
                      )
                      .concat(t.id, "\"}'\n      ")
                      .concat(
                        null !== (a = t.status) &&
                          ...
                          ? "disabled"
                          : "",
                        '\n      class="btn-blue width-1-2 btn-medium '
                      )
                      .concat(
                        null !== (l = t.status) &&
                          void 0 !== l &&
                          ...
                          ? "relative processing"
                          : "icon-left-small icon-checkmark-white",
                        '"\n    >\n      '
                      )
                      .concat(
                        null !== (i = t.status) &&
            ...
            .concat(
              t.completed && "course" === t.type && !t.reviewed
                ? ((t) => {
                    let { id: e } = t;
                    const n = (0, i.P5)("course", e);
                    return '\n    <div class="margin-vert-large" style="min-height: 82px;">\n      <p class="text-left margin-bottom-small text-2 line-tight">'
                      .concat(
                        s.s.csr.mark_complete.write_review_copy(),
                        '</p>\n      <a\n        class="btn-blue btn-medium"\n        href="/review/new/'
                      )
                      .concat(
                        n.id,
                        '"\n        rel="nofollow"\n        data-track-ga=\'{"category": "mark complete modal", "action": "write a review", "label": "'
                      )
                      .concat(e, "\"}'\n      >\n        ")
                      .concat(
                        s.s.csr.mark_complete.write_review_cta(),
                        "\n      </a>\n    </div>\n  "
                      );
                  })(t)
                : "",
            ...
            .concat(
              t.completed && "course" === t.type && t.reviewed ? c(t) : "",
              '\n    <div class="row nowrap vert-align-middle border-top border-gray-light padding-top-small">\n      <div>\n        <img width="50" src="/images/lists/edu-list-icon.png" alt="" />\n      </div>\n      <div class="margin-left-small">\n        <h4 class="text-3 weight-bold">'
            )
            .concat(
              s.s.csr.mark_complete.where_title({ type: t.type }),
              '</h4>\n        <p class="text-3">\n          '
            )
            .concat(
              (0, p.sprintf)(
                (0, d.T)(
                  s.s.csr.mark_complete.mark_as_complete_copy({ type: t.type })
                ),
                "<a data-track-ga='" +
                  JSON.stringify({
          ...
          ((0, a.sY)(
            ...
            ((t) => {
              ...
              return '\n    <button\n      data-detail=\'{\n        "id": "'
                ...
                .concat(
                  t.reviewed || !1,
                  '\n      }\'\n      data-name="PROGRESS_TRIGGER"\n      data-track-ga=\'{"category": "Mark Complete Click", "action": "'
                )
                .concat(t.id, '", "label": "')
                .concat(
                  t.type,
                  '"}\'\n      class="btn-white btn-medium small-down-icon-center icon-left-small icon-progress-'
                )
                .concat(t.completed ? "done" : "mark", '"\n    >\n      ')
                .concat(
                  t.completed &&
                    null !== (e = t.status) &&
                    void 0 !== e &&
        ...
        (0, a.sY)(
          ...
          () => {
            window.requestAnimationFrame(() => {
              "active" === n.status &&
                (0, i.px)("[name=completedStartDate]").then((t) => {
                  t.focus();
                });
            });
          }
      ...
      var y = (t) => {
        switch (t.name) {
          case "request:PROGRESS/UPDATE_SUCCESS": {
            const { id: e, type: n } = t.detail.originalParameters,
          ...
          case "submit:PROGRESS_COMPLETE": {
            ...
            const { id: a, type: l } = t.detail,
              r = "".concat(l, "-").concat(a),
              c = b(),
              d = !!t.name.match(/COMPLETE/),
              p =
                (null === (e = t.target.elements) ||
                void 0 === e ||
                null === (n = e.completedStartDate) ||
                void 0 === n
                  ? void 0
                  : n.value) || null,
              m =
                (null === (s = t.target.elements) ||
                void 0 === s ||
                null === (o = s.completedEndDate) ||
                void 0 === o
                  ? void 0
                  : o.value) || null,
              u = {};
            if (
              (p && !(0, i.qS)(p) && (u.completedStartDate = !0),
              m && !(0, i.qS)(m) && (u.completedEndDate = !0),
              (c[r] = {
                ...c[r],
                id: a,
                type: l,
          ...
          case "click:MODAL_CLOSE":
            ...
            "active" ===
              (null === (c = b()[t.detail.id]) || void 0 === c
                ? void 0
                : c.status) && h({ [t.detail.id]: { status: null } });
            break;
          case "click:PROGRESS_TRIGGER": {
            t.originalEvent.preventDefault();
            const { id: e, type: n, completed: i, reviewed: s } = t.detail,
              o = "".concat(n, "-").concat(e),
              r = b();
            if (!(0, a.y0)().user.loggedIn)
            ...
            (r[o] = {
              ...
              (r[o].status = (r[o].status || "").match(/active|success/)
                ? null
                : "active"),
              h(r),
              v(o);
        ...
        function o(t, e) {
          ...
          for (a = 0; a < g; a++)
            if ("string" == typeof t[a]) b += t[a];
              ...
              if (
                (l.not_type.test(o.type) &&
                  l.not_primitive.test(o.type) &&
                  n instanceof Function &&
                  (n = n()),
                l.numeric_arg.test(o.type) && "number" != typeof n && isNaN(n))
              )
                throw new TypeError(
              ...
              switch ((l.number.test(o.type) && (p = n >= 0), o.type)) {
                ...
                case "e":
                  n = o.precision
                    ? parseFloat(n).toExponential(o.precision)
                    : parseFloat(n).toExponential();
                  break;
                case "f":
                  n = o.precision
                    ? parseFloat(n).toFixed(o.precision)
                    : parseFloat(n);
                  break;
                case "g":
                  n = o.precision
                    ? String(Number(n.toPrecision(o.precision)))
                    : parseFloat(n);
                  break;
                case "o":
                ...
                case "s":
                  (n = String(n)),
                    (n = o.precision ? n.substring(0, o.precision) : n);
                  break;
                case "t":
                  (n = String(!!n)),
                    (n = o.precision ? n.substring(0, o.precision) : n);
              ...
              l.json.test(o.type)
                ? (b += n)
                : (!l.number.test(o.type) || (p && !o.sign)
                    ? (m = "")
                    : ((m = p ? "+" : "-"),
                      (n = n.toString().replace(l.sign, ""))),
                  (c = o.pad_char
                    ? "0" === o.pad_char
                      ? "0"
                      : o.pad_char.charAt(1)
                    : " "),
                  (d = o.width - (m + n).length),
                  (r = o.width && d > 0 ? c.repeat(d) : ""),
                  (b += o.align
                    ? m + n + r
                    : "0" === c
                    ? m + r + n
        ...
        function c(t) {
          ...
          for (var e, n = t, a = [], i = 0; n; ) {
            if (null !== (e = l.text.exec(n))) a.push(e[0]);
              ...
              if (null === (e = l.placeholder.exec(n)))
              ...
              if (e[2]) {
                ...
                for (s.push(c[1]); "" !== (o = o.substring(c[0].length)); )
                  if (null !== (c = l.key_access.exec(o))) s.push(c[1]);
                    ...
                    if (null === (c = l.index_access.exec(o)))
                      throw new SyntaxError(
                        "[sprintf] failed to parse named argument key"
                      );
                    s.push(c[1]);
